...
const Skills = () => {
  return (
    <div name="skills" className="h-screen w-full bg-[#121212] text-gray-300">
      {/* container   */}
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full ">
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-4 text-center gap-4 py-8">
          ...
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
            <img className="w-20 mx-auto" src={GitHub} alt="Github_icon" />
          ...
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
            <img className="w-20 mx-auto" src={FireBase} alt="firebase_icon" />
